...
//    @Produces("application/json")
    ...
    public String addToRollDiceService(@QueryParam("tableID") String tableID, @QueryParam("playerID") String playerID, @QueryParam("isJoined") String isJoined) throws IOException {
        if(House.getInstance().getTables().get(tableID).addToDiceRollers(playerID, isJoined))
            return "başarılı";
        return "başarısız";
    ...
    @Produces("text/plain")
    @Path("playMagicCard")
    public String playMagicCard(@QueryParam("tableID") String tableID, @QueryParam("playerID") String playerID ) throws IOException {
       House.getInstance().getTables().get(tableID).playMagicCard(playerID);
       return "başarılı";
    }
